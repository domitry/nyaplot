...
define('components/axis',['tools'], function(Tools){
    function Axis(parent, scales, _options){
        ...
        model.attr("clip-path", "url(#" + clip_id + ")");
       ...
       if(options.zoom){
           parent.call(
               d3.behavior.zoom()
                   ...
                   .on("zoom", function(){
                       parent.select(".context").attr('transform', 'translate(' + d3.event.translate + ') scale(' + d3.event.scale + ')');
...
define('main',['require','exports','module','components/scale','components/axis'],function(require, exports, module){
    var Bionya = {};
    Bionya.Nya = {
