            ...
            parent.call(
                d3.behavior.zoom()
                    ...
                    .on("zoom", function(){
                        ...
                        model.attr('transform', 'translate(' + scale*options.width/2 + ',' + scale*options.height/2 + ')');
                        model.select("clipPath").select("rect")
                            .attr({
                                "x": -options.width*scale/2,
                                "y": -options.height*scale/2
                            });
                    }));
        }
    }
...
define('diagrams/connector',['tools'], function(Tools){
    var _ = Tools._;
    var Manager = Tools.Manager;
...
define('diagrams/labels',['tools'], function(Tools){
    var _ = Tools._;
    var Manager = Tools.Manager;
...
define('main',['require','exports','module','components/scale','components/axis','diagrams/arc','diagrams/connector','diagrams/labels'],function(require, exports, module){
    var Bionya = {};
    Bionya.Nya = {
