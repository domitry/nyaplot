...
define('diagrams/label',['tools'], function(Tools){
    var _ = Tools._;
    var Manager = Tools.Manager;
    ...
    Labels.prototype.processData = function(group, x, text){
        var scales = this.scales, layer = this.options.layer;
        return _.map(_.zip(x, text), function(row){
...
define('main',['require','exports','module','components/scale','components/axis','diagrams/arc','diagrams/connector','diagrams/label'],function(require, exports, module){
    var Bionya = {};
    Bionya.Nya = {
